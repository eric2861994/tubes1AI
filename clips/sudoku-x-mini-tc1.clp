...
(defrule grid-values
   ...
   (assert (possible (row 1) (column 3) (value any) (group 1) (diag 0) (id 3)))
   ...
   (assert (possible (row 1) (column 6) (value 2) (group 2) (diag 2) (id 9)))
   ...
   (assert (possible (row 2) (column 6) (value 4) (group 2) (diag 0) (id 12)))
   ...
   (assert (possible (row 4) (column 2) (value 5) (group 3) (diag 0) (id 17)))
   (assert (possible (row 4) (column 3) (value 6) (group 3) (diag 2) (id 18)))

   (assert (possible (row 3) (column 4) (value 5) (group 4) (diag 2) (id 19)))
   ...
   (assert (possible (row 4) (column 5) (value 3) (group 4) (diag 0) (id 23)))
   (assert (possible (row 4) (column 6) (value any) (group 4) (diag 0) (id 24)))

   (assert (possible (row 5) (column 1) (value 5) (group 5) (diag 0) (id 25)))
   ...
   (assert (possible (row 6) (column 4) (value 1) (group 6) (diag 0) (id 34)))
