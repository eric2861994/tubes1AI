...
(defrule grid-values
   ...
   (assert (possible (row 1) (column 1) (value any) (group 1) (diag 1) (id 1)))
   (assert (possible (row 1) (column 2) (value any) (group 1) (diag 0) (id 2)))
   (assert (possible (row 1) (column 3) (value 1) (group 1) (diag 0) (id 3)))
   (assert (possible (row 2) (column 1) (value any) (group 1) (diag 0) (id 4)))
   (assert (possible (row 2) (column 2) (value any) (group 1) (diag 1) (id 5)))
   (assert (possible (row 2) (column 3) (value any) (group 1) (diag 0) (id 6)))
   ...
   (assert (possible (row 2) (column 4) (value 1) (group 2) (diag 0) (id 10)))
   (assert (possible (row 2) (column 5) (value 3) (group 2) (diag 2) (id 11)))
   (assert (possible (row 2) (column 6) (value 5) (group 2) (diag 0) (id 12)))

   (assert (possible (row 3) (column 1) (value any) (group 3) (diag 0) (id 13)))
   (assert (possible (row 3) (column 2) (value 6) (group 3) (diag 0) (id 14)))
   (assert (possible (row 3) (column 3) (value any) (group 3) (diag 1) (id 15)))
   (assert (possible (row 4) (column 1) (value 4) (group 3) (diag 0) (id 16)))
   ...
   (assert (possible (row 3) (column 4) (value 4) (group 4) (diag 2) (id 19)))
   (assert (possible (row 3) (column 5) (value any) (group 4) (diag 0) (id 20)))
   (assert (possible (row 3) (column 6) (value 2) (group 4) (diag 0) (id 21)))
   ...
   (assert (possible (row 5) (column 1) (value 3) (group 5) (diag 0) (id 25)))
   ...
   (assert (possible (row 6) (column 5) (value 6) (group 6) (diag 0) (id 35)))
